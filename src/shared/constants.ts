...
Наступним кроком це буде перевірка вашого ММР-у та рангу за командою - /my_rank.
Ну й тепер переходимо у гілку <a href="https://t.me/Radianite_ua/1587">Зарегати катку</a>.
Щоб почати гру пишете - /play_match

Як саме працює система:
- Ви запускаєте матч 👇;
- Система шукає вам підходящих суперників і звіряє ваші ММР 📋;
- У кого більше, той і переміг 😇;
- Переможець отримує до +30 до свого ММР рахунку і за такої нагоди, йому апається ранг 😎;
- Той хто програв втрачає теж не мало ММР, інколи навіть як в Валіку IRL 🤓;
- Репутація теж вплтває на ваш загальний ММР і ранг, тому будьте уважні 🤫;
